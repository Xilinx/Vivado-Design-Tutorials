...
#
# Versal_ssync_rxtx_intrfce_mb.tcl: Tcl script for re-creating project 'Versal_ssync_rxtx_intrfce_mb'
#
...
#
# 1. This project creation tcl script (Versal_ssync_rxtx_intrfce_mb.tcl).
#
...
set _xil_proj_name_ "Versal_ssync_rxtx_intrfce_mb"
...
set script_file "Versal_ssync_rxtx_intrfce_mb.tcl"
...
proc print_help {} {
  ...
  puts "The script contains commands for creating a project, filesets,"
...
set files [list \
 ...
 [file normalize "${origin_dir}/Design/toplevel_mb.sv"]\
]
...
set file "Design/toplevel_mb.sv"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property -name "top" -value "toplevel_mb" -objects $obj
...
set file "[file normalize ${origin_dir}/Constraints/toplevel_mb.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "Constraints/toplevel_mb.xdc"
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/Simulation/toplevel_testbench_mb.sv"]\
 [file normalize "${origin_dir}/Simulation/toplevel_sim_mb.sv"]\
]
...
set file "Simulation/toplevel_testbench_mb.sv"
...
set_property -name "top" -value "toplevel_testbench_mb" -objects $obj
...
update_compile_order -fileset sources_1
create_ip -name advanced_io_wizard -vendor xilinx.com -library ip -version 1.0 -module_name Rx_2bank_ssync_intrfce
set_property -dict [list CONFIG.Component_Name {Rx_2bank_ssync_intrfce} CONFIG.DIFF_IO_T {DIFF_TERM_ADV} CONFIG.DIFFERENTIAL_IO_TERMINATION {TERM_100} CONFIG.MAX_BANKS {2} CONFIG.DATA_SPEED {1800} CONFIG.INPUT_CLK_FREQ {225.000} CONFIG.REDUCE_CONTROL_SIG_EN {1} CONFIG.BIT_PERIOD {556} CONFIG.PLL_CLK {32.04891673562574} CONFIG.TX_WINDOW_VAL {556} CONFIG.RX_WINDOW_VAL {440} CONFIG.BUS0_IO_TYPE {DIFF} CONFIG.BUS0_NUM_PINS {4} CONFIG.BUS0_STROBE_NAME {strobe_b0} CONFIG.BUS0_STROBE_IO_TYPE {DIFF} CONFIG.BUS0_SIG_NAME {Rx_data_b0} CONFIG.BUS1_DIR {RX} CONFIG.BUS1_IO_TYPE {DIFF} CONFIG.BUS1_STROBE_EN {1} CONFIG.BUS1_NUM_PINS {2} CONFIG.BUS1_STROBE_NAME {strobe_b1} CONFIG.BUS1_STROBE_IO_TYPE {DIFF} CONFIG.BUS1_SIG_NAME {Rx_data_b1} CONFIG.DIFF_IO_STD {LVDS15}] [get_ips Rx_2bank_ssync_intrfce]
generate_target {instantiation_template} [get_files $proj_dir/${_xil_proj_name_}.srcs/sources_1/ip/Rx_2bank_ssync_intrfce/Rx_2bank_ssync_intrfce.xci]
update_compile_order -fileset sources_1
generate_target all [get_files  $proj_dir/${_xil_proj_name_}.srcs/sources_1/ip/Rx_2bank_ssync_intrfce/Rx_2bank_ssync_intrfce.xci]
catch { config_ip_cache -export [get_ips -all Rx_2bank_ssync_intrfce] }
export_ip_user_files -of_objects [get_files $proj_dir/${_xil_proj_name_}.srcs/sources_1/ip/Rx_2bank_ssync_intrfce/Rx_2bank_ssync_intrfce.xci] -no_script -sync -force -quiet
create_ip_run [get_files -of_objects [get_fileset sources_1] $proj_dir/${_xil_proj_name_}.srcs/sources_1/ip/Rx_2bank_ssync_intrfce/Rx_2bank_ssync_intrfce.xci]
launch_runs Rx_2bank_ssync_intrfce_synth_1 -jobs 8
export_simulation -of_objects [get_files $proj_dir/${_xil_proj_name_}.srcs/sources_1/ip/Rx_2bank_ssync_intrfce/Rx_2bank_ssync_intrfce.xci] -directory $proj_dir/${_xil_proj_name_}.ip_user_files/sim_scripts -ip_user_files_dir $proj_dir/${_xil_proj_name_}.ip_user_files -ipstatic_source_dir $proj_dir/${_xil_proj_name_}.ip_user_files/ipstatic -lib_map_path [list {modelsim=$proj_dir/${_xil_proj_name_}.cache/compile_simlib/modelsim} {questa=$proj_dir/${_xil_proj_name_}.cache/compile_simlib/questa} {ies=$proj_dir/${_xil_proj_name_}.cache/compile_simlib/ies} {xcelium=$proj_dir/${_xil_proj_name_}.cache/compile_simlib/xcelium} {vcs=$proj_dir/${_xil_proj_name_}.cache/compile_simlib/vcs} {riviera=$proj_dir/${_xil_proj_name_}.cache/compile_simlib/riviera}] -use_ip_compiled_libs -force -quiet
...
update_compile_order -fileset sources_1
create_ip -name advanced_io_wizard -vendor xilinx.com -library ip -version 1.0 -module_name Tx_2bank_ssync_intrfce
set_property -dict [list CONFIG.Component_Name {Tx_2bank_ssync_intrfce} CONFIG.MAX_BANKS {2} CONFIG.BUS_DIR {0} CONFIG.DATA_SPEED {1800} CONFIG.INPUT_CLK_FREQ {225.000} CONFIG.REDUCE_CONTROL_SIG_EN {1} CONFIG.BIT_PERIOD {556} CONFIG.PLL_CLK {32.04891673562574} CONFIG.TX_IOB {74} CONFIG.RX_IOB {0.00} CONFIG.RX_PHY {0.00} CONFIG.TX_PHY {1076} CONFIG.TX_WINDOW_VAL {-594} CONFIG.RX_WINDOW_VAL {556} CONFIG.BUS0_DIR {TX} CONFIG.BUS0_IO_TYPE {DIFF} CONFIG.BUS0_STROBE_EN {0} CONFIG.BUS0_NUM_PINS {4} CONFIG.BUS0_SIG_NAME {Tx_data_b0} CONFIG.BUS1_DIR {TX} CONFIG.BUS1_IO_TYPE {DIFF} CONFIG.BUS1_SIG_TYPE {Clk Fwd} CONFIG.BUS1_SIG_NAME {Clk_fwd_b0} CONFIG.BUS2_DIR {TX} CONFIG.BUS2_IO_TYPE {DIFF} CONFIG.BUS2_NUM_PINS {2} CONFIG.BUS2_SIG_NAME {Tx_data_b1} CONFIG.BUS3_DIR {TX} CONFIG.BUS3_IO_TYPE {DIFF} CONFIG.BUS3_SIG_TYPE {Clk Fwd} CONFIG.BUS3_SIG_NAME {Clk_fwd_b1} CONFIG.BUS12_WRCLK_EN {0} CONFIG.DIFF_IO_STD {LVDS15}] [get_ips Tx_2bank_ssync_intrfce]
generate_target {instantiation_template} [get_files $proj_dir/${_xil_proj_name_}.srcs/sources_1/ip/Tx_2bank_ssync_intrfce/Tx_2bank_ssync_intrfce.xci]
update_compile_order -fileset sources_1
generate_target all [get_files  $proj_dir/${_xil_proj_name_}.srcs/sources_1/ip/Tx_2bank_ssync_intrfce/Tx_2bank_ssync_intrfce.xci]
catch { config_ip_cache -export [get_ips -all Tx_2bank_ssync_intrfce] }
export_ip_user_files -of_objects [get_files $proj_dir/${_xil_proj_name_}.srcs/sources_1/ip/Tx_2bank_ssync_intrfce/Tx_2bank_ssync_intrfce.xci] -no_script -sync -force -quiet
create_ip_run [get_files -of_objects [get_fileset sources_1] $proj_dir/${_xil_proj_name_}.srcs/sources_1/ip/Tx_2bank_ssync_intrfce/Tx_2bank_ssync_intrfce.xci]
launch_runs Tx_2bank_ssync_intrfce_synth_1 -jobs 8
export_simulation -of_objects [get_files $proj_dir/${_xil_proj_name_}.srcs/sources_1/ip/Tx_2bank_ssync_intrfce/Tx_2bank_ssync_intrfce.xci] -directory $proj_dir/${_xil_proj_name_}.ip_user_files/sim_scripts -ip_user_files_dir $proj_dir/${_xil_proj_name_}.ip_user_files -ipstatic_source_dir $proj_dir/${_xil_proj_name_}.ip_user_files/ipstatic -lib_map_path [list {modelsim=$proj_dir/${_xil_proj_name_}.cache/compile_simlib/modelsim} {questa=$proj_dir/${_xil_proj_name_}.cache/compile_simlib/questa} {ies=$proj_dir/${_xil_proj_name_}.cache/compile_simlib/ies} {xcelium=$proj_dir/${_xil_proj_name_}.cache/compile_simlib/xcelium} {vcs=$proj_dir/${_xil_proj_name_}.cache/compile_simlib/vcs} {riviera=$proj_dir/${_xil_proj_name_}.cache/compile_simlib/riviera}] -use_ip_compiled_libs -force -quiet
...
set_property -dict [list CONFIG.C_NUM_PROBE_OUT {12} CONFIG.C_NUM_PROBE_IN {15} CONFIG.Component_Name {vio_0}] [get_ips vio_0]
...
set_property -dict [list CONFIG.C_BRAM_CNT {1.5} CONFIG.C_PROBE18_WIDTH {8} CONFIG.C_PROBE17_WIDTH {8} CONFIG.C_PROBE16_WIDTH {8} CONFIG.C_PROBE15_WIDTH {8} CONFIG.C_PROBE14_WIDTH {8} CONFIG.C_PROBE13_WIDTH {8} CONFIG.C_PROBE12_WIDTH {8} CONFIG.C_PROBE11_WIDTH {8} CONFIG.C_NUM_OF_PROBES {19} CONFIG.Component_Name {ila_0}] [get_ips ila_0]
