...
2.  Invoke Vivado 2025.2 IDE GUI.
...
5.  In the “Default Part” menu, select the following Versal AI device:
    ...
    <img src="./media/image2.png" style="width:4.44861in;height:3.35543in"
...
<img src="./media/image6.png" style="width:5.24081in;height:3.47917in"
...
-   Check **Loop Back Clock IO** and you can see that the loopback
    ...
    <img src="./media/image10.png" style="width:4.67677in;height:3.84722in"            
...
2.  Under **SD 1 / eMCC** **1** select the following:
    ...
    **PMC MIO 0 ..11** and the error will be eliminated for this tutorial.*
    ...
    <img src="./media/image11.png" style="width:4.80972in;height:3.95766in"            
 alt="Graphical user interface, application Description automatically generated" />  |
...
3.  The PL fabric clock needs to be configured for 200 MHz. Under
    ...
    <img src="./media/image12.png" style="width:4.45124in;height:3.65972in"      
...
3.  The “axi_slave.v” file should now appear in the “Sources” pane under
 ...
 style="width:2.96042in;height:1.76042in" />  |
      ...
      - By selecting the module in the Sources window and using the Add Module to Block Design command from the context menu, shown in the following figure.
