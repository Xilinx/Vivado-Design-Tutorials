...
set pl_axis_nmu_2 [get_noc_interfaces _5_pl_axis_MxN_top_inst/genblk1[2].xpm_nmu_strm_pl_to_pl/S_AXIS_nmu]
...
set conn_01 [create_noc_connection -source $pl_axis_nmu_1 -target $pl_axis_nsu_0]
set conn_10 [create_noc_connection -source $pl_axis_nmu_2 -target $pl_axis_nsu_0]

#Setting QoS Bandwidths
#Comment out next 3 lines
set_property -dict [list WRITE_BANDWIDTH 7000 WRITE_AVERAGE_BURST 4] $conn_00
set_property -dict [list WRITE_BANDWIDTH 7000 WRITE_AVERAGE_BURST 4] $conn_01
set_property -dict [list WRITE_BANDWIDTH 7000 WRITE_AVERAGE_BURST 4] $conn_10

#Enable multiphase and set phases
#Uncomment following 6 lines
