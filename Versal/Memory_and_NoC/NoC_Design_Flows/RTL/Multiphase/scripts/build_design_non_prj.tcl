...
#Defining number of phases for multiphase NoC
...
read_verilog {{../sources/rtl/axis_MxN_top.v} {../sources/rtl/pl_master_to_cips.v} {../sources/rtl/pl_master_to_pl_slave.v} {../sources/rtl/pl_to_pl_master.v} {../sources/rtl/validate_ip_M_AXIS.v} {../sources/rtl/design_1_wrapper.v} {../sources/rtl/pl_master_to_ddr.v} {../sources/rtl/pl_slave_from_cips.v} {../sources/rtl/pl_to_pl_slave.v} {../sources/rtl/validate_ip_S_AXIS.v}}
...
read_xdc ../sources/xdc/noc_constraints_solved.xdc
...
set_property USED_IN {synthesis_pre} [get_files ../sources/xdc/noc_constraints_solved.xdc]

#####Generate all targets : XCI/BD######
generate_target {synthesis implementation} [get_files design_1.bd]

synth_ip [get_ips { axis_MxN_vio axi_bram_ctrl_pl_slave_from_pl_master axi_bram_ctrl_pl_slave_from_ps axis_vio_pl_master_to_ddr axis_vio_pl_master_to_pl_slave axis_vio_pl_master_to_ps perf_axi_tg_pl_master_to_ddr perf_axi_tg_pl_to_pl perf_axi_tg_pl_to_ps axi_switch_0}]
