...
read_verilog {{../sources/rtl/rm1/RP1_rm1.v} {../sources/rtl/rm1/axis_S_top_rm1.v} {../sources/rtl/rm1/pl_master_to_ddr_rm1.v} {../sources/rtl/rm1/validate_ip_S_AXIS_rm1.v}}
...
read_xdc ../sources/xdc/rm1/noc_constraints_rm1.xdc
...
set_property USED_IN {synthesis_pre} [get_files ../sources/xdc/rm1/noc_constraints_rm1.xdc]

#####Generate all targets : XCI/BD######

synth_ip [get_ips { axis_vio_pl_master_to_ddr_rm1 perf_axi_tg_pl_master_to_ddr_rm1 axi_dbg_hub_rm1} ]
