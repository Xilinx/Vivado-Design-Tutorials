...
read_verilog {{../sources/rtl/rm2/RP1_rm2.v} {../sources/rtl/rm2/axis_S_top_rm2.v} {../sources/rtl/rm2/pl_master_to_ddr_rm2.v} {../sources/rtl/rm2/validate_ip_S_AXIS_rm2.v}}
...
read_xdc ../sources/xdc/rm2/noc_constraints_rm2.xdc
...
set_property USED_IN {synthesis_pre} [get_files ../sources/xdc/rm2/noc_constraints_rm2.xdc]

#####Generate all targets : XCI/BD######

synth_ip [get_ips { axis_vio_pl_master_to_ddr_rm2 perf_axi_tg_pl_master_to_ddr_rm2 axi_dbg_hub_rm2} ]
