...
# start_gui
add_files ../vivado_shells/outputs/abstract_shell.dcp
...
read_xdc ../sources/xdc/static/waivers_drc.xdc
opt_design
...
pr_verify -full_check -in_memory -additional ../vivado_shells/outputs/abstract_shell.dcp -file rp1_rm2_partial_pr_verify.log
