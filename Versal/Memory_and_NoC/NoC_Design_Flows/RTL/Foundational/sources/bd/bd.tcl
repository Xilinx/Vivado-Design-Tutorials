...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.REGION {0} \
   CONFIG.CONNECTIONS {M01_AXI {read_bw {500} write_bw {500} read_avg_burst {4} write_avg_burst {4}} MC_3 {read_bw {500} write_bw {500} read_avg_burst {4} write_avg_burst {4}}} \
   CONFIG.DEST_IDS {M01_AXI:0x0} \
   CONFIG.NOC_PARAMS {} \
...
{PMC_MIO 26 .. 36}}} \
  ...
  connect_bd_intf_net -intf_net axi_noc_0_M00_AXI [get_bd_intf_pins versal_cips_0/NOC_FPD_AXI_0] [get_bd_intf_pins axi_noc_0/M00_AXI]
  ...
  connect_bd_net -net versal_cips_0_noc_fpd_axi_axi0_clk [get_bd_pins versal_cips_0/noc_fpd_axi_axi0_clk] [get_bd_pins axi_noc_0/aclk6]
  connect_bd_net -net versal_cips_0_pl0_ref_clk [get_bd_pins versal_cips_0/pl0_ref_clk] [get_bd_ports pl0_ref_clk_0] [get_bd_pins axi_dbg_hub_0/aclk] [get_bd_pins axi_noc_0/aclk7]
