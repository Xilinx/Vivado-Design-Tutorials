...
# source perf_axi_tg_pl_to_ps.tcl
...
##################################################################
# CREATE IP perf_axi_tg_pl_to_ps
##################################################################

set perf_axi_tg_pl_to_ps [create_ip -name perf_axi_tg -vendor xilinx.com -library ip -version 1.0 -module_name perf_axi_tg_pl_to_ps]

# User Parameters
set_property -dict [list \
  CONFIG.USER_C_AXI_RDATA_WIDTH {128} \
  CONFIG.USER_C_AXI_READ_SIZE {1} \
  CONFIG.USER_C_AXI_WDATA_VALUE {0x00000000000000000000000000000000} \
  ...
  CONFIG.USER_MEM_LINEAR_DATA_SEED {0x00000000000000000000000000000000} \
  ...
  CONFIG.USER_SYNTH_DI_EN {Enabled_with_Incremental_ID} \
  CONFIG.USER_SYN_ID_WIDTH {2} \
  CONFIG.USER_TRAFFIC_SHAPING_EN {FALSE} \
] [get_ips perf_axi_tg_pl_to_ps]

# Runtime Parameters
set_property -dict { 
  GENERATE_SYNTH_CHECKPOINT {1}
} $perf_axi_tg_pl_to_ps
