...
# source perf_axi_tg_pl_to_pl.tcl
...
##################################################################
# CREATE IP perf_axi_tg_pl_to_pl
##################################################################

set perf_axi_tg_pl_to_pl [create_ip -name perf_axi_tg -vendor xilinx.com -library ip -version 1.0 -module_name perf_axi_tg_pl_to_pl]
...
] [get_ips perf_axi_tg_pl_to_pl]

# Runtime Parameters
set_property -dict { 
  GENERATE_SYNTH_CHECKPOINT {1}
} $perf_axi_tg_pl_to_pl
