...
# User Parameters
set_property CONFIG.C_NUM_PROBE_IN {2} [get_ips axis_MxN_vio]
set_property CONFIG.C_PROBE_IN0_WIDTH {16} [get_ips axis_MxN_vio]
set_property CONFIG.C_PROBE_IN1_WIDTH {16} [get_ips axis_MxN_vio]
