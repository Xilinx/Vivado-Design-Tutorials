...
Repeat Steps 2 to 5 for perform hardware validation of _2 and _3 instance. 
<p>
For _5 instance, the triggers are nets *TVALID, set each to 'R'. The done signal should be 3 on valid run. 
<p>
For _1 instance, hardware validation is not available
