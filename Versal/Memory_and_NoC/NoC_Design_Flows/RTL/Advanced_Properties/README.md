...
1. Connect to and program it.  (Note: This design targets the VCK190 Evaluation Kit)

2. In the trigger setup for hw_ila_1, filter on awvalid, select the pl_to_pl net and set the "Value" to R.
<p align="left">
  <img src="./img/all_trigger_setup.png" width="500">
</p>

3. 3. In the hw_vios->hw_vio_1 tab, add the signals by clicking on plus sign
<p align="left">
  <img src="./img/ap_hw_vio_setup.png" width="500">
</p>
...
5. 5. In the hw_vios section, go to hw_vio_1. First, set voi_axi_tg_rstn to 1. Then set tg_start_1 to 1.
<p align="left">
  <img src="./img/ap_hw_vio_trigger.png" width="500">
</p>

6. The ILA waveform after successful validation, will look like this. Address remapped from 0x0000_0040 to 0x202_0000_0040
