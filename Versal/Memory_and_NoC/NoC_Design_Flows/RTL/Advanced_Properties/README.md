...
3. In the hw_vio_1 tab, add the signals by clicking on plus sign 
<p align="left">
...
5. In the hw_vios section, go to hw_vio_1. First, set _tg_rstn to 1 and then set _tg_start to 1.
<p align="left">
