...
# source perf_axi_tg_pl_master2_to_ddr_low1.tcl
...
if { $list_projs eq "" } {
  create_project  vivado_synth_rm2 -part xcvc1902-vsva2197-2MP-e-S
...
##################################################################
# CREATE IP perf_axi_tg_pl_master2_to_ddr_low1
##################################################################

set perf_axi_tg_pl_master2_to_ddr_low1 [create_ip -name perf_axi_tg -vendor xilinx.com -library ip -version 1.0 -module_name perf_axi_tg_pl_master2_to_ddr_low1]
...
set_property -dict [list \
  ...
  CONFIG.USER_SYNTH_DEFINED_PATTERN_CSV {../../../../../sources/csv/ptg_traffic_rm2.csv} \
  CONFIG.USER_SYNTH_DI_EN {Enabled_with_Constant_ID} \
  CONFIG.USER_TRAFFIC_SHAPING_EN {FALSE} \
] [get_ips perf_axi_tg_pl_master2_to_ddr_low1]

# Runtime Parameters
set_property -dict { 
  GENERATE_SYNTH_CHECKPOINT {1}
} $perf_axi_tg_pl_master2_to_ddr_low1
