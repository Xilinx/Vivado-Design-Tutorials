...
# source perf_axi_tg_pl_master_to_ddr_low0.tcl
...
##################################################################
# CREATE IP perf_axi_tg_pl_master_to_ddr_low0
##################################################################

set perf_axi_tg_pl_master_to_ddr_low0 [create_ip -name perf_axi_tg -vendor xilinx.com -library ip -version 1.0 -module_name perf_axi_tg_pl_master_to_ddr_low0]
...
] [get_ips perf_axi_tg_pl_master_to_ddr_low0]

# Runtime Parameters
set_property -dict { 
  GENERATE_SYNTH_CHECKPOINT {1}
} $perf_axi_tg_pl_master_to_ddr_low0
