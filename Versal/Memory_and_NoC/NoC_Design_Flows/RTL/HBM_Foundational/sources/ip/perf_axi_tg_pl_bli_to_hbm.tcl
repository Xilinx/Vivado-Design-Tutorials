...
# source perf_axi_tg_pl_bli_to_hbm.tcl
...
##################################################################
# CREATE IP perf_axi_tg_pl_bli_to_hbm
##################################################################

set perf_axi_tg_pl_bli_to_hbm [create_ip -name perf_axi_tg -vendor xilinx.com -library ip -version 1.0 -module_name perf_axi_tg_pl_bli_to_hbm]
...
] [get_ips perf_axi_tg_pl_bli_to_hbm]

# Runtime Parameters
set_property -dict { 
  GENERATE_SYNTH_CHECKPOINT {1}
} $perf_axi_tg_pl_bli_to_hbm
