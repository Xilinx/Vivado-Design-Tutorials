...
1. Connect to and program the device.  (Note: This design targets the VHK158 Evaluation Kit) 
...
4. In the hw_vios tab, click '+' to add all the next, then set tg_rstb to '1', followed by tg_start to '1' (in that order):
<p align="center">
