...
generate_target {synthesis simulation instantiation_template} [get_files { vio_pl_master_to_hbm.xci perf_axi_tg_pl_bli_to_hbm.xci perf_axi_tg_pl_vnoc_to_hbm.xci design_1.bd}]
