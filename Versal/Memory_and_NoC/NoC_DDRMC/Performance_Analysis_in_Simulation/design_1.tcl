...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.USER_C_AXIS_BW_RAND_LIMIT {10} \
    CONFIG.USER_C_AXI_RBURST_OUTSTANDING_LIMIT {75} \
    CONFIG.USER_C_AXI_RDATA_WIDTH {512} \
    CONFIG.USER_C_AXI_READ_BW_RAND_LIMIT {10} \
    CONFIG.USER_C_AXI_READ_REQ_FIFO_DEPTH {65} \
    CONFIG.USER_C_AXI_READ_SIZE {1} \
    CONFIG.USER_C_AXI_WBURST_OUTSTANDING_LIMIT {75} \
    ...
    CONFIG.USER_C_AXI_WRITE_BW_RAND_LIMIT {10} \
    CONFIG.USER_C_AXI_WRITE_HIGHADDR {0x00000507FFFFFFFF} \
    CONFIG.USER_C_AXI_WRITE_REQ_FIFO_DEPTH {65} \
    CONFIG.USER_C_AXI_WRITE_SIZE {1} \
    CONFIG.USER_EN_VIO_STATUS_MONITOR {FALSE} \
    CONFIG.USER_MEM_BURST_LENGTH {4} \
    ...
    CONFIG.USER_MEM_NO_OF_DQ_PER_DQS {32} \
    CONFIG.USER_MEM_NUM_DQ_PINS {64} \
    CONFIG.USER_MEM_PRBS_WIDTH {8} \
  ...
  set_property -dict [list \
    ...
    CONFIG.USER_C_AXI_WRITE_HIGHADDR.VALUE_MODE {auto} \
    CONFIG.USER_NO_OF_SLAVE_CONNECTED.VALUE_MODE {auto} \
    CONFIG.USER_PARAM_SRC_ID.VALUE_MODE {auto} \
  ] $noc_tg_1
...
connect_bd_intf_net -intf_net [get_bd_intf_nets noc_tg_4_M_AXI] [get_bd_intf_pins axi_noc_0/S04_AXI] [get_bd_intf_pins noc_tg_pmon_4/S_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets noc_tg_5_M_AXI] [get_bd_intf_pins axi_noc_0/S05_AXI] [get_bd_intf_pins noc_tg_pmon_5/S_AXI]
