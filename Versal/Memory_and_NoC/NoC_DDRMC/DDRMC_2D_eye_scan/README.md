...
* 2D Eye Scan is a hardware feature, therefore a Versal&trade; Adaptive SoC with a LP/DDR4 memory interface is required and a hardware debug connection (eg Platform Cable USB II, SmartLynq Data Cable, or SmartLynq+ Module)

* Vivado&trade; or Vitis&trade; version 2021.1 or later
...
ChipScoPy GitHub : https://github.com/Xilinx/chipscopy
