...
<table style="width:100%">
  ...
  <tr>
    <td align="center">
      <a href="./Introduction/">Introduction to NoC2 and DDRMC5</a>
    </td>
    <td>This tutorial introduces the programmable network on chip (NoC2) and integrated DDR5/LPDDR5/5X memory controller	
 (DDRMC5) in the latest generation of Versal devices.</td>
  </tr>
</table>
