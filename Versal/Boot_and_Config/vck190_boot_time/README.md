...
* VCK190 Evaluation Board User Guide [(UG1366)](https://docs.amd.com/r/en-US/ug1366-vck190-eval-bd)
...
The Boot Time Estimator is a tool that AMD provides to estimate the time it takes to boot a design on Versal from a specific boot device. It takes some input parameters from the user (like peripheral clocks and partition sizes) to closely match the specific design. This utility is downloadable from [Answer Record 76300](https://adaptivesupport.amd.com/s/article/76300).

![Block Diagram](./Figures/VCK190_Boot_Time.PNG)

The following table shows how the estimator compares with the measurement takes by running the Design and looking at the plm log. 
