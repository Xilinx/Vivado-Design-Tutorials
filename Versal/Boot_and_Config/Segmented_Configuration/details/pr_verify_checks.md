...
<table>
  ...
  <tr>
    <td>SegConfig-Validation-20</td>
    <td>Boot NMU remap consistency</td>
    <td>Checks boot NMU remap consistency: new remap entries cannot be added in secondary PLD designs</td>
  </tr>
  </table>
