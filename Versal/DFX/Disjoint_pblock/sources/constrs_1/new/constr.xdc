...
#
# FLOORPLAN to SEE BLI OVERLAP ERROR DURING OPT_DESIGN
...
resize_pblock [get_pblocks pblock_rp2] -add {CLOCKREGION_X2Y1:CLOCKREGION_X6Y4}
...
add_cells_to_pblock [get_pblocks pblock_xpm_cdc_gen] [get_cells [list design_1_i/static_region/xpm_cdc_gen_0]] -clear_locs
