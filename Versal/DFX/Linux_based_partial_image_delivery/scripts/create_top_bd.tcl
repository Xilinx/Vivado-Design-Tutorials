...
proc create_root_design { parentCell } {
  ...
  SRC_RM_MAP./rp1.rp1rm1 {rp1rm1_inst_0} \
  SRC_RM_MAP./rp1.rp1rm2 {rp1rm2_inst_0} \
  SRC_RM_MAP./rp1.rp1rm3 {rp1rm3_inst_0} \
  ...
  set_property SELECTED_SIM_MODEL rtl  $rp1
...
2 PRESENT 1} RLAST {WIDTH 1 PRESENT 1} RUSER {WIDTH 0 PRESENT 0}}}} IPI_PROP_COUNT 1} \
  ...
  set_property -dict [list \
    ...
    CONFIG.PS_PMC_CONFIG { \
      ...
      PMC_MIO38 {{AUX_IO 0} {DIRECTION inout} {DRIVE_STRENGTH 8mA} {OUTPUT_DATA default} {PULL pullup} {SCHMITT 0} {SLEW slow} {USAGE Reserved}} \
...
2.0#SD1/eMMC1#SD1/eMMC1#SD1#SD1/eMMC1#SD1/eMMC1#SD1/eMMC1#SD1/eMMC1#SD1/eMMC1#SD1/eMMC1#SD1/eMMC1#SD1/eMMC1#GPIO 1#LPD_I2C0#LPD_I2C0#CANFD1#CANFD1#UART 0#UART 0#LPD_I2C1#LPD_I2C1#pmc_i2c#pmc_i2c####SD1/eMMC1#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem0#Gem0}\
\
...
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_0_M03_AXI] [get_bd_intf_pins axi_uartlite_0/S_AXI] [get_bd_intf_pins axis_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net versal_cips_0_pl0_ref_clk [get_bd_pins versal_cips_0/pl0_ref_clk] [get_bd_pins rp1/s_axi_aclk] [get_bd_pins axi_dbg_hub_0/aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axis_ila_0/clk] [get_bd_pins dfx_decoupler_0/to_smartconnect_aclk] [get_bd_pins dfx_decoupler_0/to_dbg_hub_aclk] [get_bd_pins dfx_decoupler_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins versal_cips_0/m_axi_fpd_aclk]
  ...
  assign_bd_address -offset 0xA4200000 -range 0x00200000 -target_address_space [get_bd_addr_spaces versal_cips_0/M_AXI_FPD] [get_bd_addr_segs rp1/axi_dbg_hub_1/S_AXI_DBG_HUB/Mem0] -force
  assign_bd_address -offset 0xA4410000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/M_AXI_FPD] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] -force
  assign_bd_address -offset 0xA4430000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/M_AXI_FPD] [get_bd_addr_segs rp1/axi_uartlite_1/S_AXI/Reg] -force
  assign_bd_address -offset 0xA4400000 -range 0x00010000 -target_address_space [get_bd_addr_spaces versal_cips_0/M_AXI_FPD] [get_bd_addr_segs dfx_decoupler_0/s_axi_reg/Reg] -force
