...
*In this release, child pblocks have been applied to these disjoint pblocks to ensure successful placement and routing. For more information on this approach, please review the [disjoint pblock](../Disjoint_pblock/) tutorial.*
