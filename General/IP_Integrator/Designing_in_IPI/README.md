...
1.  Open the Vivado® Integrated Design Environment (IDE).
    ...
    <img src="media/image1.png" style="width:5.79525in;height:4.21642in"
...
4.  In the Project Name page, shown in the following figure, set the
    ...
    <img src="media/image2.png" style="width:5.38806in;height:4.02224in"
...
6.  In the Project Type page, select **RTL Project**, and select **Do
    ...
    <img src="media/image3.png" style="width:5.55224in;height:4.17433in"
    alt="Graphical user interface, text, application, email Description automatically generated" />
...
8.  Review the project summary in the New Project Summary page.
    ...
    <img src="media/image5.png" style="width:5.3209in;height:4.02044in"
    alt="Graphical user interface, text, application, email Description automatically generated" />
...
1.  Using the Flow Navigator, select Create Block Design.
    ...
    **Create Block Design** dialog box. You can change or keep the default
    ...
    <img src="media/image6.png" style="width:3.37313in;height:2.32598in"
...
2.  There are a few different ways to add IPs in the block design-
    ...
    -   By clicking the **Add IP** button in the block design canvas. <img src="media/image7.jpg" style="width:0.29169in;height:0.22502in" />
...
so far. Users have two types of processors to choose from: Classic and RISC-V. In this section, we will demonstrate how to add a microblaze V processor.

1.  Right-click the design canvas to open the popup menu and select
    **Add IP**.

2.  In the search field, type Microblaze V and double-click the core to
...
4.  Select all the default options in the Run Block Automation dialog
    ...
    <img src="media/image23.png" style="width:5.65054in;height:3.57463in"
...
9.  Once connection automation is done, the design canvas should look something like the snapshot shown below: 

    <img src="media/image25.jpg" style="width:4.76875in;height:1.89583in" />

10. You can also change the diagram view from Default to Interfaces view as shown below.
...
11. The layout of the design should now look like the figure below with
    ...
    to redraw the subsystem design. You can also change colors, layers and other general settings by clicking  in the top right corner of the design canvas .
...
12. There are different ways of changing the view on the canvas and
    ...
    <img src="media/image51.png" style="width:6.26806in;height:2.52639in"
    alt="Diagram Description automatically generated" />
...
15. Hierarchy levels can help with organizing the blocks on the canvas
...
16. Switch the diagram view from Interfaces to Default from the top
    canvas toolbar.

17. Select the MicroBlaze subsystem hierarchy block previously created
    (hier_0), right-click and select copy.

    <img src="media/image33.png" style="width:3.34in;height:1.62in" />

18. Right-click on the white space area of the canvas and select paste.
    A second hierarchical level with the exact same content gets
    created.

19. After creating both the hierarchies, you will now have 2 Microblaze
...
20.	Add the **Debug Bridge IP** from the catalog and keep the default configuration. 

    <img src="media/image53.png" style="width:3.20027in;height:0.93341in" />

    Select the previously created debug_bridge_0 block, right-click and choose Copy. Then, right-click on an empty area of the canvas and select Paste. This will create a second Debug Bridge IP with the same configuration. You will now have 2 Debug Bridge modules. 

21.	For debug_bridge_1, change the Bridge Type to BSCAN Primitive and set the Master Count to 3.
    <img src="media/image54.png" style="width:3.20027in;height:0.93341in" />
22. Run the following TCL commands in the TCL console to make the necessary connections:

 * connect_bd_intf_net [get_bd_intf_pins debug_bridge_0/S_BSCAN] [get_bd_intf_pins debug_bridge_1/m0_bscan]
 * connect_bd_intf_net [get_bd_intf_pins debug_bridge_1/m1_bscan] [get_bd_intf_pins hier_0/mdm_1/BSCAN]
 * connect_bd_intf_net [get_bd_intf_pins debug_bridge_1/m2_bscan] [get_bd_intf_pins hier_1/mdm_1/BSCAN]
 * connect_bd_net [get_bd_pins debug_bridge_0/clk] [get_bd_pins clk_wiz_1/clk_out1]

23.	Click Run Connection Automation in the banner at the top of the design canvas.
    <img src="media/image55.jpg" style="width:3.20027in;height:0.93341in" />
24. Select **All Automation (2 out of 2 selected)** to connect M_AXI_DP
...
25. Click the **Regenerate Layout** button
...
26. The only remaining connection is the sys_rst port of the new
    hierarchical block.
    ...
    <img src="media/image56.png" style="width:6.02083in;height:1.77222in"
    alt="Diagram Description automatically generated" />
