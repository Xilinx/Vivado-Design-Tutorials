...
[Design Creation Steps : Top – Bottom BDC flow](#design-creation-steps-top-bottom-bdc-flow)
...
[Step 4: Creating Connections to all IP’s and interface](#step-4-creating-connections-to-all-ips-and-interfaces)
...
[Design Creation Steps: Bottom - Up BDC flow](#design-creation-steps-bottom---up-bdc-flow)
...
> **Note:** Figures shown here are illustrations of the Vivado Integrated Design Environment (IDE). The layout depicted here might vary from the current version.
...
<img src="./media/image1.jpg" style="width:4.20031in;height:3.056in"
...
| <img src="./media/image2.png" style="width:3.9815in;height:2.74916in" /> |
|--------------------------------------------------------------------------|
...
<img src="./media/image3.jpeg" style="width:3.52808in;height:2.65251in"
...
| <img src="./media/image4.png" style="width:4.79641in;height:3.392in" /> |
|-------------------------------------------------------------------------|

8.  Review the project summary in the New Project Summary page.

| <img src="./media/image5.png"  style="width:4.79641in;height:3.392in" />  |
|---------------------------------------------|
...
| <img src="./media/image9.png" style="width:4.53609in;height:2.61306in" />  |
|---------------------------------------------|
...
| <img src="./media/image10.png" style="width:4.472in;height:3.14201in" /> |
|--------------------------------------------------------------------------|
...
| <img src="./media/image12.jpg" style="width:4.176in;height:2.64181in" alt="Graphical user interface, text, application, Word Description automatically generated" />  |
|------------------------------------------------------------------------------------------------|
...
9.  Click the Regenerate Layout button <img src="./media/image13.png" style="width:0.16389in;height:0.16389in" /> to redraw the subsystem
    design. The optimized layout of the design should now look like the
    following figure:

| <img src="./media/image14.png" style="width:4.32398in;height:2.76207in" />  |
|---------------------------------------------|
...
| <img src="./media/image15.png" style="width:2.79167in;height:3.52778in" />  |
|---------------------------------------------|
...
| <img src="./media/image16.png" style="width:2.98626in;height:2.65291in" />  |
|---------------------------------------------|
...
| <img src="./media/image17.png" style="width:4.57411in;height:2.51261in" />  |
|---------------------------------------------|
...
| <img src="./media/image18.png" style="width:6.26806in;height:1.16389in" />  |
|---------------------------------------------|
...
| <img src="./media/image19.jpg" style="width:3.20027in;height:0.93341in" />  |
|---------------------------------------------|
...
| <img src="./media/image20.png" style="width:4.7614in;height:4.42401in" />  |
|--------------------------------------------|
...
| <img src="./media/image21.png" style="width:5.637in;height:4.04007in" /> |
|--------------------------------------------------------------------------|
...
| <img src="./media/image23.png" style="width:10in;height:5.5in"/>
...
| <img src="./media/image26.png"              
 style="width:2.19456in;height:2.69458in" />  |
...
| <img src="./media/image38.png" style="width:5.64567in;height:2.78593in" />  |
|---------------------------------------------|
...
| <img src="./media/image41.png" style="width:2.03457in;height:1.47693in" />  | <img src="./media/image42.png" style="width:3.51771in;height:2.95153in" />  |
|:-------------------------------------------:|:-------------------------------------------:|
...
<img src="./media/image43.png" style="width:2.85431in;height:1.85426in" />

8.  The design canvas should look something like the snapshot shown
    below.

| <img src="./media/image44.png" style="width:5.63889in;height:2.72639in" />  |
|---------------------------------------------|

9.  You can also switch to interface view and try other options for
    better clarity on the design canvas.

| <img src="./media/image45.png" style="width:5.60084in;height:2.11422in" />  |
...
| <img src="./media/image46.png"              style="width:3.04167in;height:3.60417in" />  |
|---------------------------------------------|
...
| <img src="./media/image47.png"              style="width:3.67686in;height:1.64131in" />  |
|---------------------------------------------|

3.  If you go to sources and double click on ‘peripherals.bd’, it should
    look like screenshot below:

| <img src="./media/image48.png"              style="width:5.49085in;height:3.36106in" />  |
|---------------------------------------------|
...
| <img src="./media/image49.png" style="width:3.79898in;height:2.95838in" />  |
|---------------------------------------------|
...
| <img src="./media/image50.png" style="width:5.69408in;height:2.79515in" />  |
|---------------------------------------------|

6.  For this Lab, you can choose the name peripheral_2

| <img src="./media/image51.png" style="width:4.52801in;height:2.22928in" />  |
|---------------------------------------------|
...
| <img src="./media/image52.png" style="width:5.16693in;height:4.13216in" />  |
|---------------------------------------------|
...
| <img src="./media/image53.png" style="width:5.33014in;height:4.15299in" />  |
|---------------------------------------------|
...
| <img src="./media/image54.png" style="width:5.23638in;height:4.42384in" />  |
|---------------------------------------------|

12. If you switch to the 'Design Runs' tab, you should see something
    like this:

| <img src="./media/image55.png" style="width:5.11137in;height:3.77797in" />  |
|---------------------------------------------|
...
| <img src="./media/image56.png" style="width:4.21549in;height:3.10433in" />  |
|---------------------------------------------|
...
| <img src="./media/image57.png" style="width:5.62944in;height:3.05005in" />  |
|---------------------------------------------|
...
| <img src="./media/image61.png" style="width:4.96553in;height:4.3405in" />  |
|--------------------------------------------|
...
| <img src="./media/image62.png" style="width:4.19466in;height:3.35434in" />  |
|---------------------------------------------|
...
| <img src="./media/image63.png" style="width:5.61628in;height:2.16449in" />  |
|---------------------------------------------|

6.  Create a sub design, source peripherals.bd in the project using tcl
    console (source peripherals.bd.tcl)

| <img src="./media/image64.png" style="width:2.84042in;height:1.86121in" />  |
|---------------------------------------------|

7.  Drag and Drop peripherals.bd from Sources/Hierarchy window onto the
    top.bd block design.

| <img src="./media/image65.png" style="width:5.52806in;height:1.44452in" alt="A picture containing graphical user interface Description automatically generated" />  |
|--------------------------------------------------------------------------------------------|
