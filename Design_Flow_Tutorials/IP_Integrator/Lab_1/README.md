...
1.  Open the Vivado® Integrated Design Environment (IDE).
    ...
    Xilinx Design Tools→ Vivado 2024.x**.

        As an alternative, click the **Vivado 2024.x** Desktop icon to start the
        Vivado IDE.
...
Designing IP Subsystems Using IP integrator  * ([UG994)](https://www.xilinx.com/cgi-bin/docs/rdoc?v=2024.2;d=ug994-vivado-ip-subsystems.pdf)
