...
#set_input_delay -clock [get_clocks virtual_clock] 0.000 [get_ports rxd_pin]
#set_input_delay -clock [get_clocks virtual_clock] -min -0.500 [get_ports rxd_pin]

#set_input_delay -clock [get_clocks -of_objects [get_ports clk_pin]] 0.000 [get_ports rxd_pin]
#set_input_delay -clock [get_clocks -of_objects [get_ports clk_pin]] -min -0.500 [get_ports rxd_pin]
...
#create_generated_clock -name spi_clk -source [get_pins inst/dac_spi_i0/out_ddr_flop_spi_clk_i0/ODDRE1_inst/C] -divide_by 1 -invert [get_ports spi_clk_pin]
...
# ## GBS set_max_delay -from [get_clocks -of_objects [get_pins clk_gen_i0/clk_core_i0/clk_rx]] -to [get_clocks -of_objects [get_pins clk_gen_i0/clk_core_i0/clk_tx]] 5.000
