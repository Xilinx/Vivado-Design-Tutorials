...
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_0_M00_AXI] [get_bd_intf_pins axis_ila_0/SLOT_0_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]
  ...
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins axis_ila_0/probe0] [get_bd_pins axis_vio_0/probe_in0] [get_bd_pins c_counter_binary_0/Q] [get_bd_pins xlslice_0/Din]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets c_counter_binary_0_Q]
  connect_bd_net -net clk_wizard_0_clk_out1 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axis_ila_0/clk] [get_bd_pins axis_vio_0/clk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins clk_wizard_0/clk_out1] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rtl_block_0/clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins versal_cips_0/m_axi_fpd_aclk]
  connect_bd_net -net dds_compiler_0_m_axis_data_tdata [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins axis_ila_0/probe1] [get_bd_pins dds_compiler_0/m_axis_data_tdata]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets dds_compiler_0_m_axis_data_tdata]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axis_ila_0/resetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net rtlcounter_0_Q [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins axis_ila_0/probe2] [get_bd_pins rtl_block_0/Q]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins dds_compiler_0/s_axis_phase_tdata] [get_bd_pins xlslice_0/Dout]
