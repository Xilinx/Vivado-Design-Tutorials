...
make_wrapper -files [get_files ../vivado_prj/2RP_gpio_bram.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse ../vivado_prj/2RP_gpio_bram.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v
...
generate_target all [get_files ../vivado_prj/2RP_gpio_bram.srcs/sources_1/bd/design_1/design_1.bd]
...
create_pr_configuration -name config_2 -partitions [list design_1_i/rp1:rp1rm2_inst_0 design_1_i/rp2:rp2rm2_inst_0 ]
