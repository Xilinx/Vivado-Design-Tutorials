...
HBM_PC1_USER_DEFINED_ADDRESS_MAP NONE} \
  ...
  connect_bd_intf_net -intf_net axi_noc_1_M00_INI [get_bd_intf_ports S00_INI] [get_bd_intf_pins axi_noc_2/S00_INI]
  connect_bd_intf_net -intf_net axi_noc_2_M00_AXI [get_bd_intf_pins axi_bram_ctrl_0/S_AXI] [get_bd_intf_pins axi_noc_2/M00_AXI]

  # Create port connections
  connect_bd_net -net clk_wizard_0_clk_out1 [get_bd_ports aclk0] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_noc_2/aclk0]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_ports s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn]

  # Create address segments
  assign_bd_address -offset 0x020180000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces S00_INI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
