...
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_1_M00_AXI] [get_bd_intf_pins axis_ila_1/SLOT_0_AXI] [get_bd_intf_pins smartconnect_1/M00_AXI]

  # Create port connections
  connect_bd_net -net axi_uartlite_1_interrupt [get_bd_ports interrupt_0] [get_bd_pins axi_uartlite_1/interrupt] [get_bd_pins axis_ila_1/probe2]
  connect_bd_net -net axi_uartlite_1_tx [get_bd_ports tx_0] [get_bd_pins axi_uartlite_1/tx] [get_bd_pins axis_ila_1/probe1]
