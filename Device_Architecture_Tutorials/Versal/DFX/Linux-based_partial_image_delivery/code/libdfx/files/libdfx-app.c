...
int main()
{
	...
	/* Load uartlite driver and check that uartlites are feeding into eachother */	
	printf("\t DFX Decoupler OFF\r\n");
	system("devmem 0xA4400000 32 0");
	sleep(3);

	printf("\t loading uartlite driver\r\n");
	system("modprobe uartlite");
	sleep (3);
	...
	printf("\t unloading uartlite driver\r\n");
	system("modprobe -r uartlite");
	sleep(3);	
