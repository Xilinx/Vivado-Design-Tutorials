...
if { $list_projs eq "" } {
   create_project axi_gpio_in_rp_versal axi_gpio_in_rp_versal -part xcvc1902-vsva2197-2MP-e-S -force
...
PS_USE_PMCPL_CLK0 1 SMON_ALARMS Set_Alarms_On SMON_ENABLE_TEMP_AVERAGING 0\
