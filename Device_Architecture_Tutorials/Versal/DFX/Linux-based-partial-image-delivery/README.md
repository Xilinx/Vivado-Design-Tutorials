...
### Before You Begin
First, for the commands in this project to work, you must source the Vivado and PetaLinux 2022.2 settings.    

```bash
source <xilinx_install>/Vivado/2022.2/settings64.sh
source <xilinx_install>/Petalinux/2022.2/settings.sh
```

Second, after having downloaded the [BSP](https://www.xilinx.com/member/forms/download/xef.html?filename=xilinx-vck190-v2022.2-10141622.bsp), move it to this project's top-level directory.
