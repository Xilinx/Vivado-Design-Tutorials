...
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_0_M03_AXI] [get_bd_intf_pins axis_ila_0/SLOT_0_AXI] [get_bd_intf_pins smartconnect_0/M03_AXI]
  ...
  connect_bd_net -net axi_uartlite_1_tx [get_bd_pins axi_uartlite_0/rx] [get_bd_pins rp1/tx_0]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins dfx_decoupler_0/s_axi_reg_aresetn] [get_bd_pins dfx_decoupler_0/to_smartconnect_arstn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins rp1/aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dbg_hub_0/aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins axis_ila_0/resetn] [get_bd_pins dfx_decoupler_0/to_dbg_hub_arstn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins rp1/s_axi_aresetn]
  ...
  connect_bd_net -net versal_cips_0_pl0_ref_clk [get_bd_pins axi_dbg_hub_0/aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axis_ila_0/clk] [get_bd_pins dfx_decoupler_0/aclk] [get_bd_pins dfx_decoupler_0/to_dbg_hub_aclk] [get_bd_pins dfx_decoupler_0/to_smartconnect_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rp1/s_axi_aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins versal_cips_0/m_axi_fpd_aclk] [get_bd_pins versal_cips_0/pl0_ref_clk]
