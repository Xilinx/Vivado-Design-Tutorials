...
create_project Design_2 ${myPath}/Design2 -part xcvh1582-vsva3697-2MP-e-S
create_bd_design "design_2"

open_bd_design {${myPath}/hbm_module_2.srcs/sources_2/bd/design_2/design_2.bd}
...
startgroup
set_property CONFIG.USER_AXI_CLK_0_FREQ {400.00} [get_bd_cells noc_clk_gen]
endgroup
