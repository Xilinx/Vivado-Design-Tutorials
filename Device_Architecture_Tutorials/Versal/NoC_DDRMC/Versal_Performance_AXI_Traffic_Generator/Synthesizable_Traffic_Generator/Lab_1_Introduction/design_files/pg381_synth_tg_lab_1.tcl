...
{PULL disable} {SCHMITT 0} {SLEW slow} {USAGE Reserved}}\
  ...
  connect_bd_net -net clk_gen_sim_0_axi_clk_0 [get_bd_pins axi_noc_0/aclk6] [get_bd_pins clk_gen_sim_0/axi_clk_0] [get_bd_pins perf_axi_tg_0/clk] [get_bd_pins perf_axi_tg_0/pclk] [get_bd_pins sim_trig_0/pclk]
