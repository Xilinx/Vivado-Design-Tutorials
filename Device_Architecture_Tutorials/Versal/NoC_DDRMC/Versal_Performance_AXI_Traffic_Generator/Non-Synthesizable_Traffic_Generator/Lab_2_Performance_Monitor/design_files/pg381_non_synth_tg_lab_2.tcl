...
connect_bd_intf_net -intf_net [get_bd_intf_nets perf_axi_tg_0_M_AXI] [get_bd_intf_pins axi_pmon_0/S_AXI] [get_bd_intf_pins perf_axi_tg_0/M_AXI]
  ...
  connect_bd_net -net clk_gen_sim_0_axi_clk_0 [get_bd_pins axi_noc_0/aclk6] [get_bd_pins axi_pmon_0/axi_aclk] [get_bd_pins clk_gen_sim_0/axi_clk_0] [get_bd_pins perf_axi_tg_0/clk] [get_bd_pins sim_trig_0/pclk]
  connect_bd_net -net clk_gen_sim_0_axi_rst_0_n [get_bd_pins axi_pmon_0/axi_arst_n] [get_bd_pins clk_gen_sim_0/axi_rst_0_n] [get_bd_pins perf_axi_tg_0/tg_rst_n] [get_bd_pins sim_trig_0/rst_n]
  ...
  connect_bd_net -net sim_trig_0_ph_trig_out [get_bd_pins perf_axi_tg_0/trigger_in] [get_bd_pins sim_trig_0/ph_trig_out]
