...
if { $list_projs eq "" } {
   create_project Lab_1 Lab_1 -part xcvc1902-vsva2197-2MP-e-S
...
{PULL disable} {SCHMITT 0} {SLEW slow} {USAGE Reserved}}\
  ...
  connect_bd_net -net clk_gen_sim_0_axi_clk_0 [get_bd_pins axi_noc_0/aclk6] [get_bd_pins clk_gen_sim_0/axi_clk_0] [get_bd_pins perf_axi_tg_0/clk] [get_bd_pins sim_trig_0/pclk]
  connect_bd_net -net clk_gen_sim_0_axi_rst_0_n [get_bd_pins clk_gen_sim_0/axi_rst_0_n] [get_bd_pins perf_axi_tg_0/tg_rst_n] [get_bd_pins sim_trig_0/rst_n]
