...
//#define PLM_PRINT
#define PLM_DEBUG		// VCK190_boot_time modification
 ...
 */
#define PLM_PRINT_PERF	// VCK190_boot_time modification
/**
...
#define PLM_PRINT_PERF_PL  // VCK190_boot_time modification
