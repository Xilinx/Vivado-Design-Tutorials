...
This Versal example design is intended to illustrate the post bootROM state (pre-PLM) of the device on different boot modes, just to verify the registers modified by Versal ROM code. The idea is to replicate for Versal the information provided on Table 6-22 and Table 6-11 of [UG585](https://docs.amd.com/r/en-US/ug585-zynq-7000-SoC-TRM) for Zynq-7000 and Table 37-7 of [UG1085](https://docs.amd.com/v/u/en-US/ug1085-zynq-ultrascale-trm) for Zynq UltraScale+ MPSoC/RFSoC.
...
In order to build and run the tutorial reference design, the following must be available or installed:
  * Vitis IDE 2023.1:
  	...
  	- For more information on installing Vitis, refer to the Vitis Unified Software Platform Embedded Software Development documentation[(UG1400)](https://docs.amd.com/r/2023.1-English/ug1400-vitis-embedded).
