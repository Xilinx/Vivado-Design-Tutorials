...
create_project slr2_rm2_compile ../../output/slr2_rm2_compile -part xcvu13p-fhga2104-3-e -force

#Add abstract shell DCP for the partition
add_files ../../output/initial_compile/abs_shells/slr2_abs.dcp
#Import the corresponding partition's BD to the project
import_files ../../output/initial_compile/project_1.srcs/sources_1/bd/rp_slr2/rp_slr2.bd
...
create_partition_def -name rp_slr2 -module rp_slr2
create_reconfig_module -name rp_slr2_rm2 -partition_def [get_partition_defs rp_slr2 ] -define_from rp_slr2

#Create  a new configuration using DFX wizard
create_pr_configuration -name config_1 -partitions [list design_1_i/rp_slr2:rp_slr2_rm2]
...
open_bd_design {../../output/slr2_rm2_compile/slr2_rm2_compile.srcs/sources_1/bd/rp_slr2/rp_slr2.bd}
source modify_slr2_bd_rm2.tcl
...
#Add constraints for slr2_rm2 xdc
add_files -fileset constrs_1 -norecurse ../../constraints/slr2_rm2_compile/slr2_rm2_misc.xdc
import_files -fileset constrs_1 [get_files slr2_rm2_misc.xdc]
...
launch_runs rp_slr2_rm2_synth_1 -jobs 8 
wait_on_run rp_slr2_rm2_synth_1

#Add the generated OOC synthesized BD's DCP output to the project
add_files ../../output/slr2_rm2_compile/slr2_rm2_compile.runs/rp_slr2_rm2_synth_1/rp_slr2.dcp

#Scope the RM DCP to the corresponding cell in the reconfigurable partition
set_property SCOPED_TO_CELLS {design_1_i/rp_slr2} [get_files ../../output/slr2_rm2_compile/slr2_rm2_compile.runs/rp_slr2_rm2_synth_1/rp_slr2.dcp]
